...
def generar_grafos(ruta_archivo, playlists, usuarios):
    grafo1 = Grafo()
    grafo2 = Grafo()
    _procesar_archivo(ruta_archivo, grafo1, playlists, usuarios)
...
def _procesar_archivo(ruta_archivo, grafo1, playlists, usuarios):
    with open(ruta_archivo) as archivo:
        ...
        while linea:
            ...
            _procesar_linea(linea, grafo1, playlists, usuarios)
            linea = archivo.readline()

def _procesar_linea(linea, grafo1, playlists, usuarios):
